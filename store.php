    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="index.php"><img class="img-fluid" src="assets/img/TCI_Logo.png"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item"><a class="nav-link" href="index.php#about">Accreditation</a></li>
                        <li class="nav-item"><a class="nav-link" href="index.php#projects">Goals</a></li>
